...
<div class="container-fluid">
    ...
    <div>
        {!! $purchasestatuses->appends(Request::only('search'))->links(); !!}
    </div>
                <div class="row">
                    <div class="col-sm-12 ">
                        <div class="white-box">
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-xs-6 col-sm-6 pull-right">
                                    ...
                                    {!! Form::open(array('method'=>'GET','url' => '/searchpurchasestatus', 'class'=>'form navbar-form navbar-right searchform')) !!}
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <a class="btn btn-default" href="{{ route('purchasestatus.index') }}">
